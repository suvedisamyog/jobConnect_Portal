...
public class saved_jobs extends Fragment {
    ...
    private SavedJobs_Adp jobAdapter;
...
ImageView noData;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = view.findViewById(R.id.savedJobRCV);
        jobList = new ArrayList<>();

        recyclerView = view.findViewById(R.id.savedJobRCV);
        noData=view.findViewById(R.id.noData);

        jobAdapter = new SavedJobs_Adp(jobList,requireActivity().getSupportFragmentManager(),getContext(),email);
    ...
    private void getSavedJobs() {
        StringRequest stringRequest=new StringRequest(Request.Method.POST, Constants.URL_ALL_SAVED_JOBS,
                response -> {
                    try {
                        JSONObject jsonObject = new JSONObject(response);
                        Log.d("AllJobssaved", "getAllJobs: "+response);
